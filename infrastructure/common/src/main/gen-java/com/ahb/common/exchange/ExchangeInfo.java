...
public class ExchangeInfo implements org.apache.thrift.TBase<ExchangeInfo, ExchangeInfo._Fields>, java.io.Serializable, Cloneable, Comparable<ExchangeInfo> {
  ...
  private static final org.apache.thrift.protocol.TField BUSINESS_OBJ_FIELD_DESC = new org.apache.thrift.protocol.TField("businessObj", org.apache.thrift.protocol.TType.STRING, (short)6);
  ...
  public java.lang.String businessObj; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    STEP((short)5, "step"),
    BUSINESS_OBJ((short)6, "businessObj");
  ...
  static {
    ...
    tmpMap.put(_Fields.BUSINESS_OBJ, new org.apache.thrift.meta_data.FieldMetaData("businessObj", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public ExchangeInfo(ExchangeInfo other) {
    ...
    if (other.isSetBusinessObj()) {
      this.businessObj = other.businessObj;
    }
  }
  ...
  public java.lang.String getBusinessObj() {
    return this.businessObj;
  }

  public ExchangeInfo setBusinessObj(java.lang.String businessObj) {
    this.businessObj = businessObj;
    return this;
  }

  public void unsetBusinessObj() {
    this.businessObj = null;
  }

  /** Returns true if field businessObj is set (has been assigned a value) and false otherwise */
  public boolean isSetBusinessObj() {
    return this.businessObj != null;
  }

  public void setBusinessObjIsSet(boolean value) {
    if (!value) {
      this.businessObj = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case BUSINESS_OBJ:
      if (value == null) {
        ...
        setBusinessObj((java.lang.String)value);
      }
      break;
  ...
  public boolean equals(ExchangeInfo that) {
    ...
    boolean this_present_businessObj = true && this.isSetBusinessObj();
    boolean that_present_businessObj = true && that.isSetBusinessObj();
    if (this_present_businessObj || that_present_businessObj) {
      if (!(this_present_businessObj && that_present_businessObj))
        return false;
      if (!this.businessObj.equals(that.businessObj))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetBusinessObj()) ? 131071 : 524287);
    if (isSetBusinessObj())
      hashCode = hashCode * 8191 + businessObj.hashCode();
  ...
  public int compareTo(ExchangeInfo other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetBusinessObj()).compareTo(other.isSetBusinessObj());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBusinessObj()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.businessObj, other.businessObj);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class ExchangeInfoStandardScheme extends org.apache.thrift.scheme.StandardScheme<ExchangeInfo> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, ExchangeInfo struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 6: // BUSINESS_OBJ
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.businessObj = iprot.readString();
              struct.setBusinessObjIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ExchangeInfo struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldEnd();
      if (struct.businessObj != null) {
        oprot.writeFieldBegin(BUSINESS_OBJ_FIELD_DESC);
        oprot.writeString(struct.businessObj);
        oprot.writeFieldEnd();
      }
